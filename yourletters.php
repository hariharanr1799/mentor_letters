...
<body>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				<li class="nav-item" style="text-align: center;">
					<a class="nav-link" href="index.php">All Letters</a>
				</li>
			</ul>
	...
	<div class="container">
		...
		<?php
			...
			$query = $conn->prepare("SELECT ID, QUESTION, DESCRIPTION, ASKEDBY, DATE FROM LETTERS WHERE ASKEDBY = '".$_SESSION['username']."' ORDER BY ID DESC");
			$query->execute();
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			if(window.innerWidth <= 690) {
				var reqdtop = window.innerHeight-130;
			}
			else {
				var reqdtop = window.innerHeight-105;
			}
